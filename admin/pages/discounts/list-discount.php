    ...
    <table class="table">
        ...
        <?php if(isset($data)):?>
            <?php foreach ($data as $discounts): ?>
                <tbody>
                <tr>
                    <th scope="row"><input type="checkbox" class="form-check-input" name="check" id="exampleCheck1"></th>
                    <td><?= $discounts['id'] ?></td>
                    ...
                    <td>
                        <a href="?page=discounts&action=edit-discount&id=<?=$discounts['id']?>"><button type="button" class="btn btn-primary">Sửa</button></a>
                        <a href="?page=discounts&action=list-discount&id=<?=$discounts['id']?>"><button type="button" class="btn btn-primary">Xóa</button></a>
                    </td>
                </tr>
                </tbody>
            <?php endforeach; ?>
