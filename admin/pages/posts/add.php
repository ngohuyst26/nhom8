...
$countPostCate = (int)$post->countAllPostCate();
    ...
    ?>
        <div class="bg-secondary rounded h-100 p-4 ">
            <div class="d-flex align-items-center justify-content-center" style="min-height: 80vh;">
                <h5 class="h5">Chưa Có Danh Mục, Hãy Tạo Danh Mục Để Thêm Bài Viết !!</h5>
                        ...
                        <div class="col-lg-8 col-sm-12">
                            <div class=" mb-5">
                                ...
                                <div style="width: 100%" class="p-lg-4 border rounded mt-3 border-light ">
                                    <img src="https://cdn11.bigcommerce.com/s-1812kprzl2/images/stencil/original/products/582/5042/no-image__63632.1665666729.jpg?c=2" alt="" id="img" class="d-block p-3 " style="min-height: 240px; width: 100%; ">
                                </div>
