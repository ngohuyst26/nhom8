...
if (isset($_GET['category'])) {
    ...
    if ($cate == 'all') {
        ...
        $getAllPost = $post->getPostByCate($cate);
    }
} else {
    $getAllPost = $post->getAllPost();
}
                ...
                <tbody>
                    ...
                    ?>
                            <tr>
                                ...
                                <td style="width:180px"><img style="width: 140px;" class="rounded" src="<?php echo !empty($post['thumbnail']) ? $post['thumbnail']  : "https://i.pinimg.com/736x/72/d2/96/72d296e10b71253eb2c259b0ad810919.jpg" ?>" alt=""></td>
                                        ...
                                        <ul class="dropdown-menu bg-secondary  border-light">
                                            ...
                                            <li>
                                                <form action="/admin/pages/posts/handel.php" method="post">
                                                    ...
                                                    <button class="btn dropdown-item text-light" type="submit" name="del">Xóa</button>
                                                </form>
                                            </li>
