...
<div class="container-fluid pt-4 px-4">
    <div class="bg-secondary text-center rounded p-4">
        ...
        <div class="text-start d-lg-flex mb-3">
            ...
            <p class="me-3"><a href="/admin/?page=posts&action=list" class="<?= (!isset($_GET['f'])) ? 'text-white' : 'text-light' ?>">Công Khai (<?= $countPushPost; ?>) </a></p>
            <p class="me-3"><a href="/admin/?page=posts&action=list&f=trash" class="<?= (isset($_GET['f']) && $_GET['f'] == 'trash') ? 'text-white' : 'text-light' ?>">Thùng rác (<?= $countTrashPost; ?>)</a> </p>
            <p class="me-3"><a href="/admin/?page=posts&action=list&f=note" class="<?= (isset($_GET['f']) && $_GET['f'] == 'note') ? 'text-white' : 'text-light' ?>">Nháp (<?= $countNotePost ?>)</a> </p>
            ...
            <div class="d-lg-flex ">
                ...
                <div class=" me-3 mb-3">
                    <form action="" method="GET">
                        ...
                        <input type="hidden" name="<?= (isset($_GET['f']) ? 'f' : '') ?>" value="<?= (isset($_GET['f']) ? $_GET['f'] : '') ?>">
                        <input type="hidden" name="<?= (isset($_GET['key']) ? 'key' : '') ?>" value="<?= (isset($_GET['key']) ? $_GET['key'] : '') ?>">
                                                ...
                                                <li class="dropdown dropstart">
                                                    ...
                                                    ?>
                                                        ...
                                                        <form action="/admin/pages/posts/handel.php" method="post">
                                                            ...
                                                            <button type="submit" name="restore" class="btn dropdown-item text-light" style="min-width:90px">Khôi Phục</button>
                                                        </form>
                                                    ...
                                                    ?>
                                                        ...
                                                        <button class="btn dropdown-item text-light" type="button" data-bs-toggle="dropdown" data-bs-auto-close='outside' aria-expanded="false">
                                                            Sửa Nhanh
                                                        </button>
                                                        ...
                                                        <ul class="dropdown-menu bg-secondary update-quick border-light">
                                                            <li>
                                                                <form action="/admin/pages/posts/handel.php" class="p-2" method="post">
                                                                    <div class="row">
                                                                        <div class="col-8">
                                                                            <p class="mb-2" style="font-size: 0.8rem;">Chỉnh Sửa Nhanh</p>
                                                                            <input type="text" name="id" value="<?= $post['id'] ?>" hidden>
                                                                            <div class="mb-1 row">
                                                                                <label for="quick-name" class="col-sm-3 col-form-label">Tiêu Đề</label>
                                                                                <div class="col-sm-9">
                                                                                    <input type="text" class="form-control" id="quick-name" name="name" value="<?= $post['name'] ?>">
                                                                                </div>
                                                                            </div>
                                                                            <div class="mb-3 row">
                                                                    ...
                                                                    <div class="d-flex justify-content-between align-items-center">
                                                                        <button type="button" class="btn btn-sm btn-outline-info" aria-expanded="false">Hủy</button>
                                                                        <button type="submit" name="quick-update" class="btn btn-sm btn-info">Cập Nhật</button>
                                                                    </div>
                        ...
                        <nav aria-label="Page navigation example">
                            <ul class="pagination justify-content-end">
                                <li class="page-item <?= (isset($_GET['offset']) && $_GET['offset'] == 0  ? 'disabled ' : '') ?> ">
                                    <a class="page-link m-1 bg-secondary text-white" href="<?= $next_page_url ?>&offset=<?= (isset($_GET['offset'])) ? $_GET['offset'] - $limit : '0' ?> " aria-label="Previous">
                                ...
                                <li class="page-item <?= (isset($_GET['offset']) && $_GET['offset'] == ($page * $limit) - $limit  ? 'disabled' : '') ?>">
                                    ...
                                    <?= $next_page_url ?>&offset=<?= (isset($_GET['offset'])) ? $_GET['offset'] + $limit : $limit ?>" aria-label="Next">
