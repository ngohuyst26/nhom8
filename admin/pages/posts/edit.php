        ...
        <div class="bg-secondary rounded h-100 p-4">
            ...
            <div class="form-floating mb-3">
                <input type="email" class="form-control" id="floatingInput" placeholder="name@example.com"
                       value="Galaxy S24 Series lộ hình ảnh render mới nhất và các tính năng AI gây sốt">
                <label for="floatingInput">Tiêu Đề bài Viết</label>
            </div>
            <div class=" mb-3">
                <label for="img-post" class="btn-primary p-2 rounded" style="min-width: 120px; text-align : center ">Hình
                    Ảnh</label>
                <input type="file" class="" id="img-post" hidden placeholder="Password">
                <img style="width: 180px;"
                     src="https://cdn.tgdd.vn/Files/2023/11/12/1554765/redmi-note-12s-114-121123-101447-800-resize.jpg"
                     alt="">
