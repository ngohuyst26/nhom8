                            ...
                            <div class="col-8">
                                <div class=" mb-5">
                                    ...
                                    <div style="width: 100%" class="p-4 border rounded mt-3 border-light ">
                                        <img src="<?php echo !empty($post['thumbnail']) ? $post['thumbnail']  : "https://i.pinimg.com/564x/79/64/48/79644808025ee0111ca37d5b88e67c02.jpg" ?>" alt="" id="img" class="d-block p-3 " style="min-height: 240px; width: 100%; ">
                                    </div>
