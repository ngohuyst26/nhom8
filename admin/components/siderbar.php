        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-secondary navbar-dark">
                ...
                <div class="navbar-nav w-100">
                    <a href="/admin" class="nav-item nav-link <?= (!isset($_GET['page']))?'active':''?>"><i class="fa fa-tachometer-alt me-2"></i>Dashboard</a>
                    <div class="nav-item dropdown">
                        <a href="#" class="nav-link dropdown-toggle <?= (isset($_GET['page']) && $_GET['page'] == 'product')?'active':''?>" data-bs-toggle="dropdown"><i class="fa fa-laptop me-2"></i>Quản lý sản phẩm</a>
