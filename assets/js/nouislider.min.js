...
!function (t) {
    ...
    function z(t, f, o) {
        ...
        return mt(e = y, f.cssClasses.target), 0 === f.dir ? mt(e, f.cssClasses.ltr) : mt(e, f.cssClasses.rtl), 0 === f.ort ? mt(e, f.cssClasses.horizontal) : mt(e, f.cssClasses.vertical), l = V(e, f.cssClasses.base), function (t, e) {
            ...
            destroy: function () {
                ...
                return v.map(lt)
            }, on: $, off: G, get: st, set: ot, setHandle: at, reset: function (t) {
                ot(f.start, t)
    ...
    return {
        __spectrum: l, version: ut, create: function (t, e) {
